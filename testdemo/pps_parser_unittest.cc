...
int main(void)
{
	...
	test.generated_pps_.bottom_field_pic_order_in_frame_present_flag = true;
	test.generated_pps_.pic_init_qp_minus26 = 25;
	test.generated_pps_.redundant_pic_cnt_present_flag = 1;  // 1 bit value.
	test.generated_pps_.weighted_bipred_idc = (1 << 2) - 1;  // 2 bit value.
	test.generated_pps_.weighted_pred_flag = true;
	test.generated_pps_.entropy_coding_mode_flag = true;
	test.generated_pps_.id = 2;
	test.generated_pps_.sps_id = 1;
	test.RunTest();
